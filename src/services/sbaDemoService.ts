...
class SBADemoService {
  ...
  private roleShowcases: Record<DemoRole, RoleShowcase> = {
    APPLICANT: {
      ...
      heroStat: '97% checklist clarity',
      entryPoint: '/applicant-portal.html',
      highlights: [
        'Program-aware checklists auto-fill as files land',
        'AI validation narrates what is missing and why it matters',
        'Secure chat back to underwriting for zero-latency handoffs',
      ],
    ...
    REVIEWER: {
      ...
      heroStat: '6 precision nudges surfaced',
      entryPoint: '/staff-portal.html',
      highlights: [
        'Queue sorted by risk, freshness, and borrower responsiveness',
        'One-click chase templates with channel suggestions',
        'Timeline captures every borrower touch without manual notes',
      ],
    ...
    APPROVER: {
      ...
      heroStat: '92% of packets auto-summarized',
      entryPoint: '/loan-ops-dashboard.html',
      highlights: [
        'AI risk narratives highlight exceptions and mitigants',
        'Exception tracking dashboard with owner + SLA',
        'Escalation-ready communications pre-filled for Teams/Email',
      ],
    ...
    ADMIN: {
      ...
      highlights: [
        'Deployment and integration health with auto-fallbacks',
        'Portfolio mix + pipeline velocity in one card',
        'Control demo sessions, seed data, and AI credentials safely',
      ],
